            ...
            <div className="w-full h-full flex">
                ...
                <div className="w-1/2 h-full">
                    ...
                    <div className="flex flex-col items-center">
                        <a className='flex flex-row w-[17vw]' href="https://github.com/sehejb" target="_blank" rel="noopener noreferrer">
                        ...
                        <a className='flex flex-row w-[17vw]' href="https://www.linkedin.com/in/sehej-brar/" target="_blank" rel="noopener noreferrer">
                        ...
                        <a className='flex flex-row w-[17vw]' href="mailto:email" target="_blank" rel="noopener noreferrer">
